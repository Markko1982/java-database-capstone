...
class AppointmentControllerLocationHeaderTest {
    ...
    @Test
    void postAppointments_deveRetornarLocationComApiPath() throws Exception {
        Long id = 123L;
        Long doctorId = 10L;
        ...
        mockMvc.perform(post("/api/appointments")
                ...
                .andExpect(header().string(HttpHeaders.LOCATION, "http://localhost/api/appointments/" + id));
    }
}
